    ...
    <footer className="w-full pb-10 " id="contact">
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm md:font-normal font-light ">
          Copyright &copy; 2026 Rubina Akther{' '}
        </p>
        <div className="flex items-center md:gap-3 gap-6 mt-10">
          {socialMedia.map((profile) => (
            <a
              ...
              rel="noreferrer"
            >
              <div className="w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300 hover:bg-zinc-800 transition-all">
                <img
                  src={profile.img}
